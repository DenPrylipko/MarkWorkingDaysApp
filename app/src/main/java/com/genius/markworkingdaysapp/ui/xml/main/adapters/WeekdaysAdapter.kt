...
class WeekdaysAdapter(
    private var inCurrentMonth: Boolean,
    ...
    override fun onBindViewHolder(
        ...
        with(holder.binding) {
            ...
            if (inCurrentMonth && element == LocalDate.now().dayOfWeek) {
    ...
    fun updateItems(newItems: List<DayOfWeek>, newInCurrentMonth: Boolean) {
        inCurrentMonth = newInCurrentMonth
        items = newItems
